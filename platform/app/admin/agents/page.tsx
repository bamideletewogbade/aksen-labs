...
export default async function AdminAgentsPage({
  ...
  return (
    <section className="admin-main" id="agents">
      ...
      {/* Three different questions used to share one scroll: what did AI do,
          how is it configured, and which tools exist. Activity is the one asked
          most, so it opens first; paging keeps working because ?page= reloads
          onto this tab. */}
      <AdminTabs
        label="AI usage"
        tabs={[
          {
            id: 'activity',
            label: 'Activity',
            note: loadFailed ? undefined : totalRuns,
            panel: (
              <section className="admin-panel activity-panel">
                ...
                {loadFailed ? (
                  ...
                  <div className="empty-admin">
                    ...
                    <span>
                      Successfully saved AI activity will appear here. Usage
                      without a saved run will not be included.
                    </span>
                  </div>
                )}
              </section>
          ...
          },
          {
            ...
            character, not prose to be read. */}
                ...
                <details className="ai-routing-more">
                  <summary>
                    How a model gets chosen, and what it may cost
                  </summary>
                  <dl className="ai-routing-facts">
                    <div>
                    ...
                    <div>
                      <dt>Output limits</dt>
                      <dd>
                        Up to 4,000 tokens per request; task-specific timeouts
                      </dd>
                    </div>
                  </dl>
                  ...
                  <p>
                    A minimum 1,024-token completion allowance accommodates
                    reasoning models; short-answer prompts still request concise
                    answers. Cost tiers guide selection;{' '}
                    <strong>they are not a spending cap</strong>. Set hard
                    budget limits in OpenRouter. Image and video generation keep
                    their separate media models.
                  </p>
                </details>
          ...
          },
          {
            ...
            panel: (
              <section className="admin-panel">
                ...
                <div className="run-list ai-entry-grid">
