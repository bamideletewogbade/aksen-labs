...
PDF = OUT / 'AI-Operations-Business-Strategy-and-90-Day-Plan.pdf'
...
class NumberedCanvas(canvas.Canvas):
    ...
    def save(self):
        ...
        for state in self.states:
            ...
            self.drawString(48,H-28,'FOUNDER STRATEGY  /  GHANA FIRST')
            self.drawRightString(W-48,H-28,'RESEARCH CHECKED 04 SEP 2026')
            self.drawString(48,25,'AI operations business  |  Evidence, experiments and execution')
...
for idx,section in enumerate(sections):
    ...
    if idx==0:
        story.append(para('BUSINESS ASSESSMENT AND 90-DAY LAUNCH PLAN','kicker'))
        story.append(para('Building a practical<br/>AI operations business'.replace('<br/>','\n'),'title'))
        story.append(para('Prepared for the founder | Aksen Labs working project','small'))
        story.append(Spacer(1,6))
    else:
        story.append(para('STRATEGY NOTE '+number,'kicker'))
...
doc=SimpleDocTemplate(str(PDF),pagesize=(W,H),rightMargin=48,leftMargin=48,topMargin=51,bottomMargin=43,
    title='Building a practical AI operations business',author='Founder strategy research',subject='Ghana-first profile, pricing and 90-day execution')
